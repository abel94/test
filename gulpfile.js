...
gulp.task("indexImages",()=>{
      return gulp.src('./src/indexImages/**/*')
            .pipe(gulp.dest('dev/indexImages'))
})
init();
gulp.task("scripts",scriptsTaskArray)
gulp.task('scss', scssTaskArray);

gulp.task("gulp-dev",["html","scripts","scss","images","indexImages","connect","watch"]);
